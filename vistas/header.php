...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-mini"><b>OSSW</b> SC</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>OSSW</b> SC</span>
    </a>
...
if ($_SESSION['acceso']==1) {
  echo '  <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="usuario.php"><i class="fa fa-circle-o"></i> Acceso</a></li>
        ...
        <li><a href="#" target="_blanck"><i class="fa  fa-exclamation-circle"></i> <span>Acerca de</span><small class="label pull-right bg-yellow">INFO</small></a></li>   
